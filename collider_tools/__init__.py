...
class BITCAKE_PT_collider_tools(Panel):
    ...
    def poll(cls, context):
        ...
        return addon_prefs.toggle_collider_tools
...
classes = (BITCAKE_PT_collider_tools,)
...
def register():
    for module in modules:
        ...
        if hasattr(module, 'draw_panel'):
            BITCAKE_PT_collider_tools.draw_funcs.append(module.draw_panel)
...
def unregister():
    ...
    BITCAKE_PT_collider_tools.draw_funcs.clear()
